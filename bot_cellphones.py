...
for i in range(NUMBER_CLICK_MORE_DATA):
    driver.find_element_by_css_selector('div.jeg_block_loadmore>a').click()
    time.sleep(random.randint(5, 10))
elements = driver.find_elements_by_css_selector("body > div.jeg_viewport > div.elementor.elementor-56052 > div > div "
                                                "> "
