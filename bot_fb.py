...
cookie = 'c_user=100073515594073; xs=35%3APBD8HkTcPqUr-w%3A2%3A1634488895%3A-1%3A-1'
driver = initDriver()
isLive = checkLiveCookie(driver, cookie)
if (isLive):
    getnumOfPostFanpage(driver, 'groups/ThinkCare', 50, 'posts.csv')
    for postId in readData('posts.csv'):
        getAmountOfComments(driver, postId, 10)